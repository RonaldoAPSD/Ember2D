...
use ember2d::engine::{GameState, RenderContext, UpdateContext, Transition};
use ember2d_sim::event::EventBus;
use ember2d_sim::world::World;
use ember2d::project::{VisualStyle, GameplayLoop, StartResult, StartTemplate};
...
impl GameState for StartScreen {
    fn on_start(&mut self, _world: &mut World, _events: &mut EventBus, _viewport_width: usize, _viewport_height: usize, _persistent: &mut std::collections::BTreeMap<String, rhai::Dynamic>) {}
